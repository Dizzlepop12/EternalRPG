...
public class ContainerInfusers extends Container {

	public IInventory tableInventory;
	private World world;

	public ContainerInfusers(InventoryPlayer inventory, TileEntityInfusersTable entity, World w) {
		world = w;
		...
		this.addSlotToContainer(new Slot(entity, 7, 80, 53));
		this.addSlotToContainer(new Slot(entity, 8, 80, 17));
